      ...
      >
        <Tabs>
          <Tabs.TabPane tab="Hilfe" key="Hilfe">
            ...
            <p>
              Die meisten Inhalte können durch anklicken editiert
              werden:
              <ul>
              ...
              Um Wortgrenzen hinzuzufügen musst du das Buchstabenfeld nach dem Wort
              markieren und Enter drücken. Dabei bitte auf die richtige
              Schreibrichtung achten.
            </p>
            <p>
              Das fertige Kreuzworträtsel kann ausgedruckt werden, die Lösungen und
              Buttons werden dabei nicht mitgedruckt.
            </p>
          </Tabs.TabPane>
          <Tabs.TabPane tab="Über" key="Über">
            ...
            <ul>
              <li>
                eine <a href="https://jonathanstriebel.de/kreuzwort">Homepage</a>{" "}
                um selbst Kreuzworträtsel zu erstellen,</li>
              <li>
                dem <a href="https://sz-magazin.sueddeutsche.de/tag/kreuzwortraetsel">
                  Kreuz mit den Worten
                </a> des Süddeutschen Zeitung Magazins entlehnt,
              </li>
              <li>
                programmiert von{" "}
              ...
              <li>
                ...
                auf <a href="https://github.com/jstriebel/kreuzwort">GitHub veröffentlicht</a>.
              </li>
            </ul>
          </Tabs.TabPane>
        </Tabs>
